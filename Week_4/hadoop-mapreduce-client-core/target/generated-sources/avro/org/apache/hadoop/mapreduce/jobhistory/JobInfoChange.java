...
public class JobInfoChange extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -7652691311157750129L;
  ...
  private static final BinaryMessageEncoder<JobInfoChange> ENCODER =
      new BinaryMessageEncoder<>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<JobInfoChange> DECODER =
   ...
   */
  public static BinaryMessageEncoder<JobInfoChange> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<JobInfoChange> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<JobInfoChange> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this JobInfoChange to a ByteBuffer.
  ...
  /**
   * Deserializes a JobInfoChange from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a JobInfoChange instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static JobInfoChange fromByteBuffer(
   ...
   * @return A new JobInfoChange RecordBuilder
   */
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<JobInfoChange>
    WRITER$ = (org.apache.avro.io.DatumWriter<JobInfoChange>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<JobInfoChange>
    READER$ = (org.apache.avro.io.DatumReader<JobInfoChange>)MODEL$.createDatumReader(SCHEMA$);
