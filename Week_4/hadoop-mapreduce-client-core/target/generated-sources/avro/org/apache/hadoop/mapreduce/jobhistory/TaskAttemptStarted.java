...
public class TaskAttemptStarted extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static BinaryMessageEncoder<TaskAttemptStarted> getEncoder() {
    return ENCODER;
  }
   ...
   * @return a TaskAttemptStarted instance decoded from the given buffer
   ...
   * @param value the value to set.
   */
  public void setShufflePort(int value) {
    ...
    throws java.io.IOException
  {
    ...
    out.writeString(this.trackerName);

    out.writeInt(this.httpPort);

    out.writeInt(this.shufflePort);
    ...
    if (this.avataar == null) {
      out.writeIndex(0);
      out.writeNull();
    } else {
      out.writeIndex(1);
      out.writeString(this.avataar);
    }
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      this.trackerName = in.readString(this.trackerName instanceof Utf8 ? (Utf8)this.trackerName : null);
      ...
      if (in.readIndex() != 1) {
        ...
        this.locality = in.readString(this.locality instanceof Utf8 ? (Utf8)this.locality : null);
      }
      ...
      if (in.readIndex() != 1) {
        ...
        this.avataar = in.readString(this.avataar instanceof Utf8 ? (Utf8)this.avataar : null);
      }
