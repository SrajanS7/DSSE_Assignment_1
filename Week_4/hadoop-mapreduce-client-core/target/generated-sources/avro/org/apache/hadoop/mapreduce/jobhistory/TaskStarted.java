...
public class TaskStarted extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static BinaryMessageEncoder<TaskStarted> getEncoder() {
    return ENCODER;
  }
   ...
   * @return a TaskStarted instance decoded from the given buffer
    ...
    throws java.io.IOException
  {
    ...
    out.writeString(this.splitLocations);
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      this.splitLocations = in.readString(this.splitLocations instanceof Utf8 ? (Utf8)this.splitLocations : null);
