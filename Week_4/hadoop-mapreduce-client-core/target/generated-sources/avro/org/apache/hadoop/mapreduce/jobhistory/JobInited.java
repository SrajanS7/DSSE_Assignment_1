...
public class JobInited extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static BinaryMessageEncoder<JobInited> getEncoder() {
    return ENCODER;
  }
   ...
   * @return a JobInited instance decoded from the given buffer
   ...
   * @param value the value to set.
   */
  public void setTotalMaps(int value) {
   ...
   * @param value the value to set.
   */
  public void setTotalReduces(int value) {
    ...
    throws java.io.IOException
  {
    ...
    out.writeInt(this.totalMaps);

    out.writeInt(this.totalReduces);

    out.writeString(this.jobStatus);

    out.writeBoolean(this.uberized);
